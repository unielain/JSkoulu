...
// add your code here
const item_img = document.querySelector(`#pictures`);


for (let i = 0; i < picArray.length; i++) {
    let article_img = document.createElement(`article`);
    let title_article = document.createElement(`h2`);
    let h2_content = document.createTextNode(`${picArray[i].title}`);
    let caption_img = document.createElement(`caption`);
    let caption_content = document.createTextNode(`${picArray[i].caption}`);
    let figure = document.createElement(`figure`);
    let medium_img = document.createElement(`img`);
    medium_img.src = picArray[i].image.medium;
    medium_img.alt = `title_from_picArray`
    let article_p = document.createElement(`p`);
    let p_content = document.createTextNode(`${picArray[i].description}`);
    let dialog = document.querySelector(`dialog`);
    let img_large = document.createElement(`img`);
    let span = document.querySelector(`span`);

    article_img.addEventListener(`click`, function (evt) {
        dialog.showModal()
        img_large.src = picArray[i].image.large;
        img_large.alt = `title_from_picArray_full_screen`;
    });
    ...
    item_img.appendChild(article_img);
    article_img.appendChild(title_article);
    title_article.appendChild(h2_content);
    article_img.appendChild(figure);
    figure.appendChild(medium_img);
    figure.appendChild(caption_img);
    caption_img.appendChild(caption_content);
    article_img.appendChild(article_p);
    article_p.appendChild(p_content);
    dialog.appendChild(img_large);
